"""
Django settings for Gro project.
...
SECRET_KEY = 'django-insecure-3!ibdea(_%541s8lihlph(w14&_(r&lk!%c8oj_t4(*y@3*1=p'
...
WSGI_APPLICATION = 'Gro.wsgi.application'
